...
class GetPlatformsUseCase @Inject constructor(private val firestoreManager: FirestoreManager) {
    suspend operator fun invoke(list: List<ContentModel>) = firestoreManager.getPlatforms(list)
}